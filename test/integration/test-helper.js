...
async function createTablesThatMayNotBeRestored(database) {
  ...
  await database.runSql('CREATE TABLE "knowledge-elements" ("userId" INTEGER, "createdAt" TIMESTAMP WITH TIME ZONE)');
  await database.runSql('INSERT INTO "knowledge-elements" ("userId", "createdAt") VALUES (2, CURRENT_TIMESTAMP)');
