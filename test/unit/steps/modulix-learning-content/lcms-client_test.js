    ...
    it('should return static learning content', async function() {
      ...
      expect(modulixLearningContent).to.deep.equal([
        ...
        },
        {
          ...
          slug: 'tmp-ia-hallu',
          title: 'Elle hallucinent, ces IA génératives ! ',
        },
        {
        ...
        },
        {
          ...
          title: 'Les IA génératives, ça consomme !',
        },
        {
        ...
        },
        {
          ...
          slug: 'tmp-ia-def-ind',
          title:
						'Une IA apprentie botaniste : un cas d\'un apprentissage supervisé 🌱',
        },
        {
        ...
        },
        {
          ...
          title:
						'Comment font les IA génératives pour répondre à nos demandes ?',
        },
        {
        ...
        },
        {
          ...
          slug: 'tmp08ef',
          title:
						'Derrière le prompt : comment fonctionnent les IA génératives ?',
        },
        {
